...
<head>
	...
	<!-- ICONS -->
	<link rel="apple-touch-icon" sizes="76x76" href="{{asset('plugins/assets/img/apple-icon.png')}}">
	<link rel="icon" type="image/png" sizes="96x96" href="{{asset('plugins/assets/img/favicon.png')}}">
</head>
			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="{{asset('plugins/assets/img/logo.png')}}" alt="Klorofil Logo"></div>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">S I   P E R K A S A</h1>
