		...
		<div class="col-xl-3 col-md-6 mb-4">
			<div class="card border-left-info shadow h-100 py-2">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-info text-uppercase mb-1"><a href="/peminjaman/detail">Total Peminjaman</a>
							</div>
							<div class="row no-gutters align-items-center">
								<div class="col-auto">
									<div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">Rp 2000000</div>
								</div>
							</div>
						</div>
						<div class="col-auto">
	...
	<div class="row">
		...
		<div class="col-xl-6 col-lg-5">
			<div class="card shadow mb-4">
				<!-- Card Header - Dropdown -->
				<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
					<h6 class="m-0 font-weight-bold text-primary" id="judul">Ajukan Peminjaman</h6>
					<div class="dropdown no-arrow">
						...
						<div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink" style="">
							...
							<a class="dropdown-item" id="peminjamanBtn" onclick="showPemnijaman()">Peminjaman</a>
							<a class="dropdown-item" id="pembayaranBtn" onclick="showPembayaran()">Pembayaran</a>
				...
				<div class="container">
					<form class="py-3" id="formPeminjaman">
					...
					<!-- <form class="py-3" id="formVerifikasi">
						<div class="form-group">
							<label for="exampleInputEmail1">Pengajuan Pinjaman Belum Diterima</label>
						</div>
						<button type="submit" class="btn btn-danger btn-block" id="cok">Cancel</button>
					</form> -->

					<form class="py-3" id="formPembayaran" style="display: none;">
						<div class="form-group">
